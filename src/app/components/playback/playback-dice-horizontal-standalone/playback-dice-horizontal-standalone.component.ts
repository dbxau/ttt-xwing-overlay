...
@Component({
  selector: 'app-playback-dice-horizontal-standalone',
  templateUrl: './playback-dice-horizontal-standalone.component.html',
  styleUrls: ['./playback-dice-horizontal-standalone.component.css']
})
export class PlaybackDiceHorizontalStandaloneComponent implements OnInit {
  key: string;
  playerindex: number;
  stream: Stream = {
    name: '',
